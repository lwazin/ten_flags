...
class Location(models.Model):
    location_store = models.OneToOneField(User, on_delete=models.CASCADE)
    location_category = models.IntegerField(default=0)


class Item(models.Model):
    item_store = models.OneToOneField(User, on_delete=models.CASCADE)
...
class Temp(models.Model):
    temp_store = models.OneToOneField(User, on_delete=models.CASCADE)
